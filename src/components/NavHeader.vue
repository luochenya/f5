          ...
          <div class="classification-item d-lg-none" v-show="isShow">
            <div class="phones-menu">
              <div class="children" v-show="!$route.meta.showNavBar">
                ...
                <div class="menu-box">
                  <ul>
                    <li><a @click="$router.push('/memberCenter'),isShows()">會員中心</a></li>
                    <li><a @click="toMyPublishedArticles(),isShows()">發表文章</a></li>
                    <li><a @click="toPointsRecord(),isShows()">點數記錄</a></li>
                    <li><a @click="toProjectRegistration(),isShows()">專案註冊</a></li>
                    <li><a @click="toProjectReview(),isShows()">專案審核</a></li>
                    ...
                    <ul>
                      ...
                      <li @click="isShowUl= !isShowUl">
                        ...
                        <ul :class="{'checked':isShowUl}">
                          <li><a @click="gotoIndex('1'),isShows()">零壹科技ZERONE</a></li>
                          <li><a @click="gotoIndex('2'),isShows()">逸盈科技NETFOS</a></li>
                          <li><a @click="gotoIndex('22'),isShows()">創泓科技Uniforce</a></li>
                        </ul>
                      </li>
                      <li><a @click="gotoIndex('3'),isShows()">經銷商專區</a></li>
                      <li><a  @click="$emit('gotoDownloads')">下載專區</a></li>
                      <li><a @click="gotoPointsMall(),isShows()">點數商城</a></li>
                    </ul>
                    <div class="btn" v-show="$route.meta.showNavBar"  @click="gotoRegisterMember">加入會員</div>
                  </div>
                </div>
